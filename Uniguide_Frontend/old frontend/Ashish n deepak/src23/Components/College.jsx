  ...
  return (
    <div>
      <div style={{marginTop:"10px",marginBottom:"20px"}}>
        {/* <a><h3><button>Add College</button></h3></a> */}
        <span variant="contained" style={{display: 'flex', justifyContent: 'right',margin:"10px"}} ><a  href="/collegelogin" class="btn btn-outline-secondary pmd-ripple-effect d-none d-lg-block mr-3" 
        data-modal-box="" data-for="file" data-close-on-click="no" style={{width:"fit-content"}} >ADD YOUR INSTITUTE</a></span>
              ...
              <div className="card p-2">
                        <div className="d-flex align-items-center" >
                            ...
                            <div className="ml-3 w-100 " style={{alignContent:""}}>
                                    <h3 className="mb-0 mt-0 textLeft">{clgName}</h3>
                                    <br></br>
                                    <ul>
